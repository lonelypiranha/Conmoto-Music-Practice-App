...
public class JsonReaderTest extends JsonTest {
    ...
    void testReaderFilledSongLibrary() {
        ...
        try {
            ...
            Session s1 = new Session(12, 11, 50, 3.3f, 120, LocalDate.of(2024, 12, 9), LocalTime.of(22, 33, 45, 431239000), LocalTime.of(23, 1, 7, 123124000));
            Session s2 = new Session(69, 30, 100, 5, 900, LocalDate.of(2020, 2, 11), LocalTime.of(12, 22, 33, 333000), LocalTime.of(14, 12, 54, 434544000));
            Session s3 = new Session(70, 31, 101, 6.6f, 100, LocalDate.of(2020, 2, 11), LocalTime.of(15, 22, 33, 333000), LocalTime.of(16, 12, 54, 434544000));
            ...
            Session s5 = new Session(100, 2, 100, 1.1f, 550, LocalDate.of(1456, 4, 30), LocalTime.of(4, 24, 30, 234111000), LocalTime.of(7, 22, 34, 908456000));
